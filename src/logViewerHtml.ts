  ...
  <div class="toolbar">
    <div class="toolbar-row">
      <div class="toolbar-actions">
        <button type="button" id="btn-clear" title="Clear all logs">Clear</button>
        <button type="button" id="btn-collapse" title="Collapse all blocks">Collapse All</button>
        <button type="button" id="btn-expand" title="Expand all blocks">Expand All</button>
        <button type="button" id="btn-new-viewer" class="toolbar-btn-accent" title="Open another Flutter Logs tab with the same live stream (filters are independent)" aria-label="Open another Flutter Logs viewer">+ Viewer</button>
      </div>
